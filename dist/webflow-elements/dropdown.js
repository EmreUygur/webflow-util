...
exports.WebflowDropdown = exports.Sa5Dropdown = void 0;
/*
 * Webflow Dropdown.
 */
/*
...
var Sa5DropdownType;
(function (Sa5DropdownType) {
    Sa5DropdownType["Native"] = "native";
    Sa5DropdownType["Custom"] = "custom"; // SA5 replaced
})(Sa5DropdownType || (Sa5DropdownType = {}));
class Sa5Dropdown {
    //#region PROPERTYS
    // .w-dropdown
    get element() {
...
*/
    ...
    init() {
        ...
        switch (this._element.getAttribute(globals_1.Sa5Attribute.ATTR_ELEMENT_DROPDOWN_INIT)?.toLowerCase()) {
            case "open": {
                //                console.log("opening")
                this.open();
                break;
...
exports.Sa5Dropdown = Sa5Dropdown;
// (window as any).WebflowDropdown = WebflowDropdown;
webflow_core_1.Sa5Core.startup(Sa5Dropdown);
/**
 * LEGACY HACK
 * To continue supporting WebflowDropdown class name
 */
class WebflowDropdown extends Sa5Dropdown {
}
exports.WebflowDropdown = WebflowDropdown;
webflow_core_1.Sa5Core.startup(WebflowDropdown);
