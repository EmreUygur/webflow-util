...
exports.Sa5CollectionList = void 0;
const globals_1 = require("../globals");
// Webflow breakpoints
class Sa5CollectionList {
    ...
    sort() {
        ...
        const mode = list.getAttribute(globals_1.Sa5Attribute.ATTR_SORT // "wfu-sort"
        ) || "default";
        const dir = list.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_DIR // "wfu-sort-dir"
        ) || "asc";
        const sortType = list.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_TYPE // "wfu-sort-type"
        ) || "string";
        ...
        if (dir == "random") {
            ...
            items.sort((a, b) => {
                const key1 = a.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_KEY) || // "wfu-sort-key"
                    a.querySelector(globals_1.Sa5Attribute.getBracketed(globals_1.Sa5Attribute.ATTR_SORT_KEY))?.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_KEY) || ''; // "[wfu-sort-key]"
                const key2 = b.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_KEY) ||
                    b.querySelector(globals_1.Sa5Attribute.getBracketed(globals_1.Sa5Attribute.ATTR_SORT_KEY))?.getAttribute(globals_1.Sa5Attribute.ATTR_SORT_KEY) || '';
        ...
        list.removeAttribute(globals_1.Sa5Attribute.ATTR_SORT); // "wfu-sort" 
        console.groupEnd();
    }
}
exports.Sa5CollectionList = Sa5CollectionList;
//#region Sorting
/* sortCollectionList
