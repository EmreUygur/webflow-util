...
exports.Sa5Rating = void 0;
const globals_1 = require("./globals");
// import { renderRatingComponent } from "./modules/webflow-ui";
class Sa5Rating {
    set rating(rating) {
        this._rating = rating;
        this._element.setAttribute(globals_1.Sa5Attribute.ATTR_RATING, // "wfu-rating"
    ...
    constructor(element) {
        ...
        this._rating = Number(element.getAttribute(globals_1.Sa5Attribute.ATTR_RATING // "wfu-rating"
        ));
    }
    init() {
        this.render();
    ...
    render() {
        let ratingValue = Number(this._element.getAttribute(globals_1.Sa5Attribute.ATTR_RATING // "wfu-rating"
        ));
