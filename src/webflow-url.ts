...
import {
  QueryPassthroughConfig,
  Sa5QueryPassthrough,
} from "./webflow-url/queryPassthrough";
import { WfuRelativeLinkFixup } from "./webflow-url/relativeLinkFixup";
import {
  TargetExternalConfig,
  WfuTargetLinks,
} from "./webflow-url/targetLinks";

// import {} from './webflow-url/query'
// import {} from './webflow-url/relativeLinkFixup'
// import {} from './webflow-url/relativeLinkFixup'

type GetConfigCallback = (Sa5UrlConfig) => Sa5UrlConfig;
...
export class Sa5Url {
  ...
  init() {
    ...
    if (this.config.passthrough) {
      new Sa5QueryPassthrough(this.config.passthroughConfig).init();
    }
